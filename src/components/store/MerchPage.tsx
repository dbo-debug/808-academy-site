...
const MERCH_ITEMS: MerchItem[] = [
  {
    ...
    priceLabel: "$89",
    stripePriceId: "price_1SdzbqDgVrA91WNOqITtToKp",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$79",
    stripePriceId: "price_1Sdzc3DgVrA91WNOBHzpSPuo",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$39",
    stripePriceId: "price_1SdzbsDgVrA91WNOjuBy6RxY",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$39",
    stripePriceId: "price_1SdzbuDgVrA91WNO48o9cpwJ",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$39",
    stripePriceId: "price_1SdzbwDgVrA91WNOiaQOyUL1",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$39",
    stripePriceId: "price_1SdzbxDgVrA91WNOM0anr7Ns",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$12",
    stripePriceId: "price_1SdzbzDgVrA91WNOzKHxQMxp",
    images: [
      {
  ...
  },
  {
    ...
    priceLabel: "$24",
    stripePriceId: "price_1Sdzc5DgVrA91WNOP0ulQpAn",
    images: [
      {
        src: "/assets/lounge/store/merch/notebook-prod.jpg",
        alt: "808 Session Notebook product shot",
      },
    ],
  },
];
      ...
      <div className="flex flex-1 flex-col justify-between">
        <div>
          ...
          <p className="mt-3 text-sm font-semibold text-[#00FFF7]">
            {item.priceLabel} <span className="text-xs text-white/60">+ tax &amp; shipping</span>
          </p>

          <p className="mt-1 text-[11px] text-white/50">
            Secure checkout via Stripe. Orders ship quickly.
          </p>
        </div>
        ...
        <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <span className="text-[11px] text-white/50">Ships fast</span>
        </div>
      </div>
    </article>
  );
    ...
    <div className="mx-auto max-w-5xl space-y-8">
      <header className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#00FFF7]">
              {variant === "public" ? "Store" : "Student Store"}
            </p>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">
              808 Academy Merch
            </h1>
            <p className="mt-2 max-w-xl text-sm text-white/70">
              Official merch is live. Secure checkout via Stripe.
            </p>
            <p className="mt-2 text-xs text-white/60">
              Hoodies <span className="font-semibold">$79–89</span> • Tees &amp; caps{" "}
              <span className="font-semibold">$39</span> • Stickers{" "}
              <span className="font-semibold">$12</span> • Notebook{" "}
          ...
          <div className="flex flex-col items-start gap-3 sm:items-end">
            {variant === "student" ? (
              ...
              <Link href="/" className="text-xs text-white/70 hover:text-white/100">
                ← Back Home
              </Link>
            )}
          </div>
        ...
        <div className="mt-4 inline-flex items-center rounded-full border border-white/10 bg-black/40 px-4 py-1 text-[11px] uppercase tracking-[0.16em] text-white/70">
          In stock • Ships fast • Secure checkout
        </div>
      </header>
